...
//----------------------------------------------------------------
#define BME280_1_adresse (0x77)
#define BME280_2_adresse (0x76)
//----------------------------------------------------------------
...
//----------------------------------------------------------------
byte HX711_SCK[4] = {A0, A0, 6, 7}; // HX711 Nr.1: A,B;  HX711 Nr.2: A,B   S-Clock
byte HX711_DT[4] =  {A1, A1, 6, 7}; // HX711 Nr.1: A,B;  HX711 Nr.2: A,B   Data
//----------------------------------------------------------------
...
byte GSM_RX = 8;       // beelogger_Universal (NANO)
#else
byte GSM_RX = 10;      // beelogger Solar (PRO MINI)
#endif
//----------------------------------------------------------------
